      ...
      <div className="container">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center pb-8">
          <div className="w-full md:w-auto">
            <img src="assets/logo-white.png" alt="Mycelial Health Logo" className="h-16 w-auto" />
          </div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-8">
              ...
              <div>
                ...
                <p className="text-sm font-bold">
                  <a href="mailto:info@mycelial.health" className="hover:opacity-80 transition-colors">info@mycelial.health</a>
                </p>
              </div>
              <div>
